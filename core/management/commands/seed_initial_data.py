...
class Command(BaseCommand):
    ...
    def _seed_scan_profiles(self):
        profiles = [
            ...
            ('web_basic', 'Pipeline web base de fingerprinting + endpoints + headers + exposición básica'),
            ('web_misconfig', 'Pipeline web de misconfiguración y hardening (nikto + nuclei misconfig + headers)'),
            ('web_appsec', 'Pipeline web AppSec modular orientado a vulnerabilidades de aplicación'),
