...
from .views import AssetDetailView, AssetListView, DashboardHomeView, FindingDetailView, FindingListView, KnowledgeBaseListView, ScanProfileListView
...
urlpatterns = [
    ...
    path('scans/create/', ScanCreateView.as_view(), name='scans-create'),
