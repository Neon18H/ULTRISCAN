...
class AdvisorySyncJob(TimeStampedModel):
    ...
    current_start_index = models.PositiveIntegerField(default=0)
    current_window_start = models.DateTimeField(null=True, blank=True)
    current_window_end = models.DateTimeField(null=True, blank=True)
